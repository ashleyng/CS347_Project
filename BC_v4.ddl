...
CREATE TABLE BC_contract
  (
    ...
    BC_department_contact_department_contact_id NUMBER
  ) ;
...
--  ERROR: FK name length exceeds maximum allowed length(30)
ALTER TABLE BC_contract ADD CONSTRAINT BC_contract_BC_department_contact_FK FOREIGN KEY ( BC_department_contact_department_contact_id ) REFERENCES BC_department_contact ( department_contact_id ) ;
