...
for each row
begin
select BC_communication_seq.nextval into :new.BC_communication_ID from dual;
end;
/
...
for each row
begin
select BC_employee_seq.nextval into :new.BC_employee_ID from dual;
end;
/
...
for each row
begin
select BC_invoices_seq.nextval into :new.BC_invoices_ID from dual;
end;
/
...
DROP INDEX BC_contract_contract_i_FK_1 ;
CREATE INDEX BC_contract_contract_i_FK_1 ON BC_checklist(BC_contract_contract_id) ;